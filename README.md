...
- A scrcpy build compiled with audio forwarding support (v2.0 or newer) if you plan to enable host audio playback.
...
7. Toggle **Enable audio** before starting the stream to forward device audio (requires a scrcpy build with audio support).
